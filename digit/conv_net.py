...
class ConvNet:
    ...
    def network(self):
        ...
        with tf.name_scope('fc1'):
            W_fc1 = weight_variable([7 * 7 * 64, 1024], 'w3_full')
            b_fc1 = bias_variable([1024], 'b3_full')

            h_pool2_flat = tf.reshape(h_pool2, [-1, 7*7*64], name='h3_reshape')
        ...
        with tf.name_scope('fc2'):
            W_fc2 = weight_variable([1024, 10], 'w4_out')
